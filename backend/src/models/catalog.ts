import type { Shape, Size, Ingredient, Bakery, DietaryOption, Pair, Preset, OrderStatus } from '../types.js';
...
export const BATTERS: Ingredient[] = [
...
export const FROSTINGS: Ingredient[] = [
...
export const ALL: Record<string, Ingredient> = Object.fromEntries([...BATTERS, ...FROSTINGS, ...TOPPINGS].map((x) => [x.id, x]));
...
export const OPTIONS: DietaryOption[] = [
...
export const OCCASIONS = ['Birthday', 'Anniversary', 'Just for me', 'Office party'] as const;
export const CRAVINGS: ReadonlyArray<readonly [string, string]> = [['fruity', 'Fruity'], ['chocolatey', 'Chocolatey'], ['creamy', 'Creamy'], ['nutty', 'Nutty'], ['fresh', 'Fresh & light'], ['korean', 'Korean taste']];
export const SWEET: ReadonlyArray<readonly [number, string]> = [[1, 'Light'], [2, 'Medium'], [3, 'Very sweet']];
...
export const STEPS_PICKUP: ReadonlyArray<readonly [OrderStatus, string]> = [['received', 'Order received'], ['accepted', 'Bakery accepted'], ['baking', 'Baking now'], ['ready', 'Ready'], ['pickedup', 'Picked up']];
export const STEPS_DELIVERY: ReadonlyArray<readonly [OrderStatus, string]> = [['received', 'Order received'], ['accepted', 'Bakery accepted'], ['baking', 'Baking now'], ['ready', 'Ready'], ['delivering', 'On the way'], ['delivered', 'Delivered']];
export const ORDER_STATUSES = ['received', 'accepted', 'baking', 'ready', 'delivering', 'delivered', 'pickedup', 'declined'] as const satisfies readonly OrderStatus[];
